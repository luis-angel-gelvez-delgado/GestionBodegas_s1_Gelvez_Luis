...
-- Usuarios
INSERT IGNORE INTO `usuario` (nombre, username, password, rol) VALUES
...
-- Bodegas
INSERT IGNORE INTO `bodega` (nombre, ubicacion, capacidad, encargado) VALUES
('Bodega Central', 'Bogota',   1000, 'Admin LogiTrack'),
('Bodega Norte',   'Medellin', 800,  'Carlos Empleado'),
('Bodega Sur',     'Cali',     600,  'Maria Empleada');

-- Productos
INSERT IGNORE INTO `producto` (nombre, categoria, stock, precio) VALUES
